...
| Camper Profile | `/camper/:id` | Full detail for one camper: schedule with location, staff, and counselors shown per period; contacts; notes. Admin can edit all fields or delete the record. Schedule entries link directly to class rosters. A **Quick Dismiss** card on the profile lets admin log an early dismissal without going through the attendance or dismissals page. |
